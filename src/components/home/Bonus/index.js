...
export default function Bonus() {
    ...
    return <div className="bonus fonts-white">
        <div className="bonus__text">
            ...
            <div className="bonus__item bonus__item-1">
                <p className="text-big">{t("BONUS_TEXT1")}</p>
            </div>
            <div className="bonus__item bonus__item-2">
                <p className="text-big">{t("BONUS_TEXT2")}</p>
            </div>
            <div className="bonus__item bonus__item-3">
                <p className="text-big">{t("BONUS_TEXT3")}</p>
            </div>
            <div className="bonus__item">
                <p className="text-big">{t("BONUS_TEXT4")}</p>
            </div>
            <div className="bonus__item bonus__item_date">
                <p className="text-title-less">{t("BONUS_TEXT5")} Pochayna Event Hall</p>
            </div>
            <div className="bonus__item-box flex">
                <div className="bonus__item-buy">
            ...
            <div className="bonus__questions">
