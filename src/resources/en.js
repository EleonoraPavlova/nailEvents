const localisation = {
  translation: {
    ...
    RETAILERS_TEXT: 'Get direct communication with potential domestic and foreign buyers, and expand markets - the forum is planned to attend more than 1,500 manicurists, owners of beauty salons, studios and schools',
    RETAILERS_TEXT1: 'See and test all the novelties of the next season - presentations of their collections will be held by about 30 best manufacturers of the Nail industry',
    RETAILERS_TEXT2: 'Opportunity to present your trading platform as effectively as possible only to the target audience - our event brings together the best nail service professionals who will come to see next year\'s',
